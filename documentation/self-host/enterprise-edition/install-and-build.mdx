...
Copy the contents of the `.env.example` file found in the root directory of the [cloned repository](https://github.com/hoppscotch/hoppscotch) to `.env` and add your values for the environment variables.
