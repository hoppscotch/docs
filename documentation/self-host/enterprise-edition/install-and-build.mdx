...
Copy the contents of the `.env.example` file present below  to `.env` and add your values for the environment variables.
...
ENTERPRISE_LICENSE_KEY="INSERT LICENSE KEY HERE"
