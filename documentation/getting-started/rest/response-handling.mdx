...
- **HTML:** Renders the response as HTML for visual representation and structured content as a web page.
...
- The example will be stored in the request's history in the collection for easy retrieval and reference later.
