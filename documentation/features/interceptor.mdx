...
<Tabs>
  ...
  <Tab title="Proxy">
    ...
    - You can replace the default Proxy URL with your own proxy middleware if you wish or use [Proxyscotch](#proxyscotch), which acts as a remote proxy server for routing API requests.
