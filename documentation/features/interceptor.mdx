...
<AccordionGroup>
  <Accordion title="Mac" icon="apple">
    <Card title="Apple-Silicon (.dmg)" href="https://github.com/hoppscotch/agent-releases/releases/download/v0.1.1/Hoppscotch_Agent_mac_aarch64.dmg">
      Download for Apple Silicon processors (M1, M2).
    </Card>
    <Card title="For Intel-based Macs (.dmg)" href="https://github.com/hoppscotch/agent-releases/releases/download/v0.1.1/Hoppscotch_Agent_mac_x64.dmg">
      Download for Intel-based Macs.
    </Card>
  </Accordion>
  <Accordion title="Windows" icon="windows">
    <Card title="Windows Installer (.msi)" href="https://github.com/hoppscotch/agent-releases/releases/download/v0.1.1/Hoppscotch_Agent_win_x64.msi">
      Download for Windows (64-bit).
    </Card>
  </Accordion>
  <Accordion title="Linux" icon="linux">
    <Card title="Debian (.deb)" href="https://github.com/hoppscotch/agent-releases/releases/download/v0.1.1/Hoppscotch_Agent_linux_x64.deb">
      Download for Debian-based distributions like Ubuntu and Linux Mint.
    </Card>
    <Card title="App Image (.AppImage)" href="https://github.com/hoppscotch/agent-releases/releases/download/v0.1.1/Hoppscotch_Agent_linux_x64.AppImage">
