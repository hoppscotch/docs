...
4. Click the **“Retry”** button to refresh the **Agent Status**.
5. Once the Hoppscotch Agent is successfully activated, click the **"+"** button to register it. A **registration code** for the connection will be generated. **Copy this code** from the agent window.
6. Paste the copied **Agent Code** into the corresponding field in the Hoppscotch application and click **"✔"** to verify and establish a secure connection.

Upon successful verification, the registration code will be obfuscated for security, and all API requests made from the Hoppscotch web app will be routed through the Hoppscotch Agent, effectively resolving CORS issues.

<Tip> To view the list of registration IDs generated over time, click on the Hoppscotch Agent icon in your system tray and select the **"Show Registration"** option from the panel. </Tip>
