...
<AccordionGroup>
  <Accordion title="Mac" icon="apple" defaultOpen="true">
    <Card title="Apple-Silicon (.dmg)" icon="laptop" href="">
      Download for Apple Silicon processors (M1, M2).
    </Card>
    <Card title="For Intel-based Macs (.dmg)" icon="microchip" href="">
      Download for Intel-based Macs.
    </Card>
  </Accordion>

  <Accordion title="Windows" icon="windows">
    <Card title="Windows Installer (.exe)" icon="microsoft" href="">
      Download for Windows (64-bit).
    </Card>
  </Accordion>

  <Accordion title="Linux" icon="linux">
    <Card title="Debian (.deb)" icon="debian" href="">
      Download for Debian-based distributions like Ubuntu and Linux Mint.
    </Card>
    <Card title="App Image (.AppImage)" icon="gear" href="">
