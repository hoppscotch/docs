...
The Collection Runner is a powerful tool that allows you to run a collection of requests sequentially. You can also configure the run settings to suit your needs.
...
You can choose to run the collection from CLI or through web interface based on your preference. A new tab will open where you can configure the run settings as described below.
...
After setting up your preferences, start the collection runner. A new tab will display the real-time execution details, including:
