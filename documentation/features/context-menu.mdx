...
> and request-specific variables. For more details on these scopes
...
`https://jsonplaceholder.typicode.com/?user=1`, now the **user** with ID **1**
will be included in the parameter placeholder.
