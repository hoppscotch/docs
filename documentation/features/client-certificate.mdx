...
description: Add and manage client certificates for SSL authentication in the Hoppscotch Desktop App to authenticate your API requests.
---

Add client certificates in the [Hoppscotch Desktop App](https://hoppscotch.com/download) to authenticate your identity when connecting to secure APIs.
