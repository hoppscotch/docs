...
<Note> These features are available exclusively on [Hoppscotch Cloud](https://hoppscotch.io) and our [Desktop app](https://hoppscotch.com/download). They are **NOT** currently supported in the Self-Hosted Edition. </Note>
