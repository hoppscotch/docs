...
Environment variables scoped to a team workspace.
...
Environment variables scoped to your personal workspace.
...
Individual requests stored inside a personal collection.
