...
<AccordionGroup>
  <Accordion title="Mac" icon="apple">
    ...
    <Card title="Apple Silicon Portable (.dmg)" href="https://github.com/hoppscotch/releases/releases/latest/download/Hoppscotch_mac_aarch64-portable.dmg">
      Download the portable version for Apple Silicon-based Mac.
    </Card>
  ...
  <Accordion title="Windows" icon="windows">
    ...
    <Card title="Windows Portable (.exe)" href="https://github.com/hoppscotch/releases/releases/latest/download/Hoppscotch_win_x64-portable.exe">
