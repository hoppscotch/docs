...
<CardGroup>
  <HeroCard
    imgLight="/images/hoppscotch-cloud-light.svg"
    imgDark="/images/hoppscotch-cloud-dark.svg"
    title="Hoppscotch Cloud"
    description="Everything you need to get started with Hoppscotch, hosted by us."
    href="https://hoppscotch.io"
  />
  <HeroCard
    imgLight="/images/hoppscotch-self-host-light.svg"
    imgDark="/images/hoppscotch-self-host-dark.svg"
