...
<CardGroup>
  <HeroCard
    imgLight="/images/hoppscotch-cloud-light.png"
    imgDark="/images/hoppscotch-cloud-dark.png"
    title="Hoppscotch Cloud"
    description="Everything you need to get started with Hoppscotch, hosted by us."
    href="https://hoppscotch.io"
  />
  <HeroCard
    imgLight="/images/hoppscotch-self-host-light.png"
    imgDark="/images/hoppscotch-self-host-dark.png"
