...
### Using the AIO container
<!-- ToDo: add links to DockerHub -->
The [All-In-One (AIO)](http://localhost:3000/documentation/self-host/community-edition/setting-up-hoppscotch) is a single container that initialises all the services required for Hoppscotch to run (Hoppscotch App, Hoppscotch Admin Dashboard, and the Hoppscotch Backend).
...
Open the browser to [http://localhost:3100](http://localhost:3100/) to [access](/documentation/self-host/community-edition/access) the admin app.
