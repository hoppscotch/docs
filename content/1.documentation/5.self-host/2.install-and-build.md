...
# Auth Tokens Config
SIGNED_COOKIE_SECRET = "supersecretcode123"
JWT_SECRET="anothersupersecretcode123"
TOKEN_SALT_COMPLEXITY=10
MAGIC_LINK_TOKEN_VALIDITY= 3
REFRESH_TOKEN_VALIDITY="604800000" # Default validity is 7 days (604800000 ms) in ms
ACCESS_TOKEN_VALIDITY="86400000" # Default validity is 1 day (86400000 ms) in ms
SESSION_SECRET='adifferentmegasecretcode123'
...
6. `SIGNED_COOKIE_SECRET`, `JWT_SECRET`, `SESSION_SECRET`: Secret Keys for security purposes
7. `APP_DOMAIN`: The domain for the backend, this is configurable in inside `packages/hoppscotch-backend/Dockerfile`
8. `REDIRECT_URL`: Is a fallback URL to debug when the actual redirects fail
