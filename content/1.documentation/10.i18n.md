...
4. **Create a target language file in the [`locales`](https://github.com/hoppscotch/hoppscotch/tree/main/packages/hoppscotch-common/locales) directory.**
...
The `i18n` branch will be merged into the `main` branch once every week.
