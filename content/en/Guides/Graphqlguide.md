...
## Resources to learn more about GraphQL
 There are tons of guides and resources on GraphQL all over the internet , We wont be going over the basics here. *This Guide is to demo Hoppscotch's  GraphQL editor* .However if you want to know more about GraphQL here is a list of resources and tutorials that most people found useful:
...
Lets us know write a query  *GetCapsuleInfo* ,to get data associated with Crew Dragon Capsule that was  used to launch Astronauts.
