...
elements into your website or project.
...
Buttons offer a more advanced widget option and can be embedded in HTML or
Markdown files. You can customize how they look and act to fit your needs.

Embed this button in documentation, website or blogs to provide easy access to
your request.
...
[Embed Example](https://hoppscotch-embed-widget.netlify.app/)
...
3. Click the **"Create"** button to generate the links.
