...
To learn more about setting up new Workspaces and collaborating with your team on APIs, head over to our [documenatation for Workspaces](https://docs.hoppscotch.io/documentation/features/workspaces).
