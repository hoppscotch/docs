...
<CardGroup cols={1}>
  ...
  <Card title="Managing your Enterprise License Key" iconType="light" icon="circle-arrow-right" href="/guides/articles/manage-an-enterprise-license-key">
    This guide provides step-by-step instructions for managing your Hoppscotch Enterprise Edition license key. If you plan to self-host the Hoppscotch Enterprise Edition...
  </Card>
  <Card title="Audit Logs" iconType="light" icon="circle-arrow-right" href="/guides/articles/understanding-graphql">
    In Enterprise Hoppscotch, a record of all actions taken on the platform is saved which can be used to know what events happened...
  </Card>
</CardGroup>
